...
// @version     1.5.2b
// @grant none
// @author 	UPDATED by XDAAST | Orinially by zdoom and Bluepix
// ==/UserScript==
...
qx.Class.define("cdccta_map.container",
		...
		construct: function()
		{
			...
			var div = new qx.html.Element('div', null, {id: 'canvasContainer'});
					...
					grid.set({ minWidth: 1500, backgroundColor: '#0b2833', minHeight: 524, margin: 3, paddingTop: 10 });
					rightBar.set({ maxWidth: 200, minWidth: 130, paddingTop: 30, paddingRight: 10 });
					leftBar.set({ maxWidth: 200, minWidth: 130, paddingTop: 30, paddingLeft: 10 });
