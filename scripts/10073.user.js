// ==UserScript==
// @name          CENTER DRIVEN Compass - Tiberium Alliances
// @namespace     https://cncapp*.alliances.commandandconquer.com/*/index.aspx*
// @include       https://cncapp*.alliances.commandandconquer.com/*/index.aspx*
// @description   Creates compass poiting to the currently selected base (compass points from itself).
// @version       2.00
// @author        MrHIDEn (in game PEEU) based on Caine code. Forked and fixed by XDaast.
// @grant         none
// ==/UserScript==
(function () {
function injectBody()
{
  ...
  var pluginName = "Center Driven Compass";
  var created = false;
  function CreateClasses() {
    ...
    qx.Class.define("PluginsLib." + pluginName,
    {
      ...
      statics : {
        NAME: 'Center Driven Compass',
        PLUGIN: 'mhNavigator',
        AUTHOR: 'MrHIDEn, XDaast',
        VERSION: 2.0,
        REQUIRES: '',
        NEEDS: 'Menu',
        INFO: 'This script is a compass and navigator.',
        WWW: '',
        ONPLUGIN: null,
        ONOPTIONS: null,
        SIZE: 0
      ...
      construct: function() {
        try {
          this.stats.src = '';//1.0.0 1.1.0 1.2.0 1.3x
          this.Self = this;
          ...
          this.winName = "CD Compass " + this.constructor.VERSION.toFixed(2);
          ...
          this.win.set({
            ...
            //allowMinimize:false,
            resizable:false,
            toolTipText: "Center Driven Compass"
          });
